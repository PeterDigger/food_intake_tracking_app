<?php
    ...
    $query =  $conn->query("SELECT admin_name, admin_email FROM admin WHERE admin_ID = '$uID'");
...
<div class="background">
    ...
    <div class="md:col-span-1 bg-white md:w-1/2">
        <form method="POST" action="../backends/admin_update_profile.php" enctype="multipart/form-data">
        ...
        <div class="place-self-center grid w-9/12 md:col-span-2">
            <h4 class="font-bold mt-12 pb-2 text-xl border-b border-black">Profile</h4>
                ...
                <input type='text' name='username' 
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  placeholder='Enter your name' value='<?php echo $adminname?>'>
