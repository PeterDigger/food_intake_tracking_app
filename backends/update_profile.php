<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if(!empty($_POST['oldpassword']) && !empty($_POST['newpassword'])){
            ...
            $oldpasswordDA = $row['user_password'];
            ...
            if ($oldpassword == $oldpasswordDA) {
                ...
                $query = "UPDATE users SET user_password = '$newpassword' WHERE user_email = '$email'";
                $result = mysqli_query($conn, $query);
            ...
            if(!empty($_POST['username'])){
                ...
                $query = "UPDATE users SET user_name = '$username' WHERE user_email = '$email'";
                $result = mysqli_query($conn, $query);
            ...
            if (!isset($uploadOk) || $uploadOk == 0) {
                ...
                $sql = "UPDATE users SET profile_photo='$target_file' WHERE user_ID='$uID'";
